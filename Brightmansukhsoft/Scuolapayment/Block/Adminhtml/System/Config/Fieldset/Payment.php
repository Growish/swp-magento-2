 ...
 */
namespace Brightmansukhsoft\Scuolapayment\Block\Adminhtml\System\Config\Fieldset;
...
class Payment extends \Magento\Config\Block\System\Config\Form\Fieldset
{
    ...
    protected function _getHeaderTitleHtml($element)
    {
        ...
        $html .= '<div class="button-container scuolapaybuttoncontainer"><button type="button"' .
        ...
        $html .= '</div>';
        $html .= '<div class="heading scuolapyheading"><strong>' . $element->getLegend() . '</strong>';
